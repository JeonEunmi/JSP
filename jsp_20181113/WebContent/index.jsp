...
<%
	...
	for (Guestbook g : list) {
		...
		if (g.getBlind() == 0) {
			...
			sb.append(String.format("<td><img src=\"%s/resources/img/Fotolia%s.png\" title=\"%s\"></td>", path,
					randomNum, g.getName_()));
...
<%=pageNumTemp == endPage%>
		...
		$("#btnNext").on("click", function(){
			var pageNum = $(this).val();
			window.location.assign("<%=path%>/index.jsp?pageCount="+<%=pageCountTemp%>+"&pageNum=" + pageNum);
		});
		...
		<div class="panel page-header" style="text-align: center;">
			<h1 style="font-size: xx-large;">
				...
				<a href="<%=path%>/index.jsp"><img
					src="resources/img/sist_logo.png" alt="sist_logo.png"></a> 방명록 <small>v1.0 made by Eunmi</small>
